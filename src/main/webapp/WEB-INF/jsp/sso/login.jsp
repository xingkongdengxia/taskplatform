...
<html lang="zh-cn">
    <head>
        ...
        <link href="<c:url value="/resources/admin/plugins/checkbix/css/checkbix.min.css" />" rel="stylesheet"/>
        <link href="<c:url value="/resources/admin/css/login.css" />" rel="stylesheet"/>
    </head>
    <body>
        <div id="login-window">
            ...
            <a id="login-bt" href="javascript:login();" class="waves-effect waves-button waves-float"><i class="zmdi zmdi-arrow-forward"></i></a>
        </div>
        ...
        <script src="<c:url value="/resources/admin/plugins/checkbix/js/checkbix.min.js" />"></script>
        <script>var BASE_PATH = '${basePath}';</script>
        <script>var BACK_URL = '${param.backurl}';</script>
        <script src="<c:url value="/resources/admin/js/login.js" />"></script>
        <script>
