...
<html lang="zh-cn">
    <head>
        ...
        <link href="${basePath}/resources/admin/plugins/checkbix/css/checkbix.min.css" rel="stylesheet"/>
    ...
    <body>
        ...
        <script src="${basePath}/resources/admin/plugins/checkbix/js/checkbix.min.js"></script>
