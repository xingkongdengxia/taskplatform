package com.smg.framework.upms.server.controller;
...
import com.smg.framework.upms.client.shiro.session.UpmsSession;
...
public class SSOController extends BaseController {
    ...
    public Object login(HttpServletRequest request, HttpServletResponse response, ModelMap modelMap) {
        ...
        if (StringUtils.isBlank(hasCode)) {
            ...
            RedisUtil.lpush(UPMS_SERVER_SESSION_IDS, sessionId);
            // 默认验证帐号密码正确，创建code
