...
public class TpTaskChild extends TpTask {
     ...
     * 经办人历史序列
     */
    private String operatorlistName;
	...
	public String getOperatorlistName() {
		return operatorlistName;
	}

	public void setOperatorlistName(String operatorlistName) {
		this.operatorlistName = operatorlistName;
	}
