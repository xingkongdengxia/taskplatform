...
<link href="<c:url value="/resources/admin/plugins/bootstrap-table-1.11.0/bootstrap-table.min.css" />" rel="stylesheet"/> 
...
<link href="<c:url value="/resources/admin/plugins/awesome-bootstrap-checkbox/awesome-bootstrap-checkbox.css" />" rel="stylesheet"/>
<link href="<c:url value="/resources/admin/plugins/select2/css/select2.min.css" />" rel="stylesheet"/>
<link href="<c:url value="/resources/admin/plugins/select2/theme/select2-bootstrap.min.css" />" rel="stylesheet"/>
