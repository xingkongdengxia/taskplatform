    ...
    <body>
        <div id='wrap'>
            <div class='content_wrap'>
                <div class='panel panel-default'>                   
                    ...
                    <input type="hidden" name='id' id='id' value='${tpTaskOperWeiyiuser.id }' class='form-control' autocomplete='off' />                 
                        <table class='table table-form'>                             
                             <tr>
                             	 <th>名称</th>
                                <td><div class="row">
                                        <div class="col-xs-12">                                           
                                            <input type='text' name='paramName' id='paramName' value='${tpTaskOperWeiyiuser.paramName }' class='form-control' autocomplete='off' />
                                        </div>                                                                            
                                    </div>
                                </td>
                             </tr>                                          
                             <tr>
                                ...
                                <td><div class="row">
                                        <div class="col-xs-12">                                           
                                            <input type='text' name='paramValue' id='paramValue' value='${tpTaskOperWeiyiuser.paramValue }' class='form-control' autocomplete='off' />
                                        </div>                                                                            
                                    </div>
                                </td>
                             </tr>                                          
                        ...
                        <button type="button" class="btn btn-primary" id="updatetask" onclick="javascript:updateweiyiuser();">保存</button>
    	...
    	if(power != undefined){
     	...
     	if(mage == 'view'){//详情
            ...
            //修改
            function updateweiyiuser() {
                $.ajax({
                    type: 'post',
                    url: '${basePath}/weiyiuserController/updateweiyiuser',
                    data: $('#addtaskform').serialize(),
                    beforeSend: function () {
