...
<html lang="zh-cn">
    ...
    <body>
                    ...
                    <form class='form-condensed' method='post' id='addtaskform'>                    
                        <table class='table table-form'>   
                            ...
                            <tr>
                                ...
                                <th>任务类型</th>
                                <td><div class="row">
                                <input id="updatetask_taskId" type="hidden" class="form-control" name="taskId" value="${tpTaskChild.taskId }"> 
                                        <div class="col-xs-3">
                            ...
                            <tr>
                                ...
                                <td><div class="row">
                                        <div class="col-xs-6">                                           
                                            <input type='text' name='showcc' id='area_btn_ycc' value='${tpTaskChild.ccRealname }' onclick="show_lay('cc')" class='form-control' autocomplete='off' />                                           
                                            <input id="nruid_ycc" type="hidden" class="form-control" name="cc" value="${tpTaskChild.cc }">
                                        </div>
                                        <div class="col-xs-6"></div>                                      
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td><div class="row">
                                        <div class="col-xs-12">                                           
                                            <input type='text' name='title' id='title' value='${tpTaskChild.title }' class='form-control' autocomplete='off' />
                                        </div>                                                                            
                                    </div>
                                </td>
                            </tr>      
                            <tr>
                                ...
                                <td><div class="row">
                                        <div class="col-xs-12">                                           
                                            <textarea name='description' id='description' rows='10' class='form-control'>${tpTaskChild.description }</textarea>
                                        </div>                                                                            
                                    </div>
                                </td>
                            </tr>   
                            <tr>
                                ...
                                <td><div class="row">
                                        <div class="col-xs-3 input-group date form_date" data-date="" data-date-format="yyyy-mm-dd" data-link-field="dtp_starttime" data-link-format="yyyy-mm-dd">                                           
                                            <input id="starttime" class="form-control" size="16" type="text" value="${tpTaskChild.showStarttime }" readonly>
                            ...
                            <tr>
                                ...
                                <td><div class="row">
                                        <div class="col-xs-3 input-group date form_date" data-date="" data-date-format="yyyy-mm-dd" data-link-field="dtp_endtime" data-link-format="yyyy-mm-dd">                                           
                                            <input id="endtime" class="form-control" size="16" type="text" value="${tpTaskChild.showEndtime }" readonly>
                                            <span class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span>
                                            <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
                        		...
                        		<button type="button" class="btn btn-primary" onclick="javascript:addtask();">保存</button>
        ...
        <script>
        	/* 初始化 */
        	var taskType = ${tpTaskChild.taskType};
        	var priority = ${tpTaskChild.priority};
        	$("#task_type").find("option:contains('"+taskType+"')").prop("selected",true);//任务类型
        	$("#priority").find("option:contains('"+priority+"')").prop("selected",true);//优先级
