    ...
    <body>
        ...
        <script>
            ...
            function actionFormatter(value, row, index) {
                return [
                    '<a class="update"  href="javascript:;" onclick="viewAction()" target="_parent" data-toggle="tooltip" title="查看"><i class="glyphicon glyphicon-eye-open"></i></a>　'
            ...
            function viewAction() {
                ...
                if (rows.length != 1) {
                    ...
                    window.location='${basePath}/manage/task/taskinfo?taskId=' + rows[0].taskId;
